...
// ==================== ESP32-C3 Super Mini 专用(唤醒用的GPIO4不要修改，可以适用C3 Super Mini、C6完整版) ====================
#define I2C_SDA 6
#define I2C_SCL 7
...
void setup() {
  ...
  Serial.println("\n===== ESP 启动 =====");
  // ==============================================
  // 🔥🔥🔥 ESP32 C3-Supper-Mini必须加这两行！开启外置天线（信号满格）
  // ==============================================
  //gpio_set_direction(GPIO_NUM_3, GPIO_MODE_OUTPUT);
  //gpio_set_level(GPIO_NUM_3, 1);  // 开启外置IPEX天线

    // 打开外置天线（WiFi必开）
  pinMode(GPIO_NUM_3, OUTPUT);
  digitalWrite(GPIO_NUM_3, 1);
